    ...
    public boolean configureDeck(String userId, List<String> cardIds) {
        ...
        try {
            ...
            if (oldDeckId == null) {
                ...
                System.out.println("⚠️ Ein altes Deck existiert bereits. Es wird nicht neu erstellt.");
            }
            ...
            for (var cardId : cardIds) {
                ...
                if (retunValue == 0) {
                    System.out.println("⚠️ Fehler beim Update für Karte " + cardId);
                    back = true;
                    break;
                }
            }
            ...
            if (back) {
                System.out.println("⚠️ Fehler beim Karten-Update, altes Deck wird wiederhergestellt.");
                return false;
            }
